...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback{
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        ((LinkManAdapter.ViewHolder) viewHolder).tvDelete.setText("左滑删除");
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) ((LinkManAdapter.ViewHolder) viewHolder).tvDelete.getLayoutParams();
        params.width = 150;
        params.height = 150;
        ((LinkManAdapter.ViewHolder) viewHolder).tvDelete.setLayoutParams(params);
    }
